...
const booksDB = [
    ...
    },
    {
        ...
        listPrice: '₹109',
        yourPrice: 'Free',
        description: 'Deep in the wilderness, a group of hikers stumbles upon an abandoned campsite that shouldn\'t exist on any map. As they investigate, they realize they\'ve walked into something far more sinister.'
    },
    {
...
const categoriesDB = [
    { name: 'Thriller', iconUrl: 'assets/covers/category_thriller_icon.jpg' },
    { name: 'Science Fiction', iconUrl: 'assets/covers/category_scifi_icon.jpg' },
    { name: 'Horror', iconUrl: 'assets/covers/category_horror_icon.jpg' },
    { name: 'Kids', iconUrl: 'assets/covers/category_kids_icon.jpg' },
    { name: 'Romance', iconUrl: 'assets/covers/category_romance_icon.jpg' }
];
